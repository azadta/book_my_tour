...
const CloudCardOne = () => {
  return (
    <div className="cloudCard-one ">
        ...
        <p className='pt-7 font-caveat text-3xl text-'>Experience stunning views, authentic cuisine.</p>
