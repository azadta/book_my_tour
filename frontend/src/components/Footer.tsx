      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="hover:underline">Most Rated Desinations</li>
            <li className="hover:underline">Offer Packages</li>
            <li className="hover:underline">Provided Facilities</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="hover:underline">Cancellation Policy</li>
          </ul>
        </div>
