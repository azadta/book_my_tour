  ...
  return (
      ...
      <div className="cloudCard-two ">
        ...
        <div className="cloud-two ">
         ...
         <p className='pt-5 font-caveat text-3xl text-'>Luxury stays, curated experiences, and breathtaking scenery.</p>

      </div>
  )
}

export default CloudCardTwo