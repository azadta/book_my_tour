export const Types = {
  ...
  PackageCategoryController: Symbol.for("PackageCategoryController"),
  PackageController: Symbol.for("PackageController"),
  PackageDestinationController: Symbol.for("PackageDestinationController"),
  PackageReviewController: Symbol.for("PackageReviewController"),
